...
YAHOO.tool.Profiler = {
     ...
     * @static
     */
    _saveData : function (name /*:String*/, duration /*:int*/, stamp1, stamp2){
        ...
        if (!functionData.stamps) {
            functionData.stamps = [];
        }
        functionData.stamps.push({ start: stamp1, stop: stamp2});
    ...
    registerFunction : function(name /*:String*/, owner /*:Object*/, registerPrototype /*:Boolean*/) /*:Void*/{
        ...
        if (YAHOO.lang.isFunction(method) && !method.__yuiProfiled){
            ...
            owner[funcName] = function () {
                ...
                YAHOO.tool.Profiler._saveData(name, stop-start, start.getTime(), stop.getTime());
